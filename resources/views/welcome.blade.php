...
<head>
  ...
  <!-- =======================================================
  * Template Name: GODGETWOLF
  * Template URL: https://bootstrapmade.com/GODGETWOLF-bootstrap-template/
        ...
        <ul class="nav nav-tabs row  d-flex" data-aos="fade-up" data-aos-delay="100">
          <li class="nav-item col-3">
            {{-- <a class="nav-link active show" data-bs-toggle="tab" data-bs-target="#features-tab-1"> --}}
              ...
              <h4 class="d-none d-lg-block">1. Concept</h4>
            {{-- </a> --}}
          </li>
          <li class="nav-item col-3">
            {{-- <a class="nav-link" data-bs-toggle="tab" data-bs-target="#features-tab-2"> --}}
              <i class="bi bi-box-seam"></i>
              <h4 class="d-none d-lg-block">2. Prepare</h4>
            {{-- </a> --}}
          </li>
          <li class="nav-item col-3">
            {{-- <a class="nav-link" data-bs-toggle="tab" data-bs-target="#features-tab-3"> --}}
              <i class="bi bi-brightness-high"></i>
              <h4 class="d-none d-lg-block">3. Retouch</h4>
            {{-- </a> --}}
          </li>
          <li class="nav-item col-3">
            {{-- <a class="nav-link" data-bs-toggle="tab" data-bs-target="#features-tab-4"> --}}
              <i class="bi bi-command"></i>
              <h4 class="d-none d-lg-block">4. Finalize</h4>
            {{-- </a> --}}
          </li>
        </ul><!-- End Tab Nav -->
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item  position-relative">
              ...
              <p>Create a website. Static Websites 'blog or journal..etc' or Dynamic Websites 'to make reservations or give your customers identification</p>
            </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <p>Create a Mobile Application. Realize Mobile applications for Android or IOS to help your customers or Realize Desktop applications for PC and desktop operating systems to help your customers.'s.</p>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="service-item position-relative">
              ...
              <p>Create a logo or design. Create your logos and flyers, etc. for your brand and for advertising Celebrate your brand. We offer you the digital marketing service on social networks and internet which is the best web solution for advertising and marketing.'s.</p>
            </div>
          </div>
          <!-- End Service Item -->
        ...
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
          ...
          <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
              <img src="{{asset('assets/img/masonry-portfolio/df.png')}}" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>App 1</h4>
                {{-- <p>Lorem ipsum, dolor sit</p> --}}
                <a href="{{asset('assets/img/masonry-portfolio/df.png')}}" title="App 1" data-gallery="portfolio-gallery-app" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->

            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
              <img src="{{asset('assets/img/masonry-portfolio/images.php@.jpg')}}" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Product 1</h4>
                {{-- <p>Lorem ipsum, dolor sit</p> --}}
                <a href="{{asset('assets/img/masonry-portfolio/images.php@.jpg')}}" title="Product 1" data-gallery="portfolio-gallery-product" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->

            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
              <img src="{{asset('assets/img/masonry-portfolio/images.png')}}" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Branding 1</h4>
                {{-- <p>Lorem ipsum, dolor sit</p> --}}
                <a href="{{asset('assets/img/masonry-portfolio/images.png')}}" title="Branding 1" data-gallery="portfolio-gallery-branding" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  ...
                  <span>"I am very pleased to deal with a Moroccan site for the first time, I hope to work with you again on a new project"</span>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="200">
              ...
              <div>
                <h3>Address</h3>
                <p>28 SCALPCLIFFE ROAD BURTON-ON-TRENT ENGLAND DE15 9AA</p>
              </div>
            </div><!-- End Info Item -->
